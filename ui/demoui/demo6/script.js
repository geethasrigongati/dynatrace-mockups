document.addEventListener('DOMContentLoaded', () => {
    // Generate mock SVG data for CPU usage (Mostly low spikes of yellow/cyan)
    const cpuSvg = generateStackedSvg([
        { color: '#55c5cc', volatility: 2, base: 1 }, // cyan (user)
        { color: '#fcebbc', volatility: 5, base: 2 }, // yellow (wait)
    ...
    const trafficSvg = generateSpikyLineSvg('#3b348f', 15, 60); // Dark Purple out
    const trafficSvg2 = generateSpikyLineSvg('#5a84b5', 10, 30); // Blue in
