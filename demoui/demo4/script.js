document.addEventListener('DOMContentLoaded', () => {
    // Generate mock SVG data for CPU usage (Mostly low spikes of yellow/cyan, similar to demo3 but data is 7.93%)
    const cpuSvg = generateStackedSvg([
        { color: '#55c5cc', volatility: 3, base: 2 }, // cyan (user)
        { color: '#fcebbc', volatility: 6, base: 3 }, // yellow (wait)
